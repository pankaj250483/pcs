const observer1 = new IntersectionObserver(entries => {
    entries.forEach(entry => {
      ...
      if (entry.isIntersecting) {
        square1.classList.add('animate__backInLeft');
        return; // if we added the class, exit the function
      }
  
      // We're not intersecting, so remove the class!
      square1.classList.remove('animate__backInLeft');
    });
  });
  ...
  const observer2 = new IntersectionObserver(entries => {
    entries.forEach(entry => {
      ...
      if (entry.isIntersecting) {
        square2.classList.add('animate__backInRight');
        return; // if we added the class, exit the function
      }
  
      // We're not intersecting, so remove the class!
      square2.classList.remove('animate__backInRight');
    });
  });
 ...
 /* ===================================================================  */
  ...
  const observer3 = new IntersectionObserver(entries => {
    entries.forEach(entry => {
      ...
      if (entry.isIntersecting) {
        square3.classList.add('animate__pulse');
        return; // if we added the class, exit the function
      }
  
      // We're not intersecting, so remove the class!
      square3.classList.remove('animate__pulse');
    });
  });
